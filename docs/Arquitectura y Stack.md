...
* **Frontend (Cliente):** React.js + Tailwind CSS + Socket.io-client.(El código real en client/ son archivos HTML + vanilla JS sin configuración de npm, sin React, sin Tailwind.)
